...
(function(){
  ...
  const LINK_PERM=[
    ...
    [/products\.html/,'products_view'],[/product-editor/,'products_edit'],[/inventory\.html/,'inventory_view'],
    [/orders\.html/,'orders_view'],[/repairs\.html/,'repairs'],[/customers\.html/,'customers'],[/coupons\.html/,'coupons'],
    ...
    [/staff-access\.html/,'staff'],[/editor\.html/,'website'],[/banners\.html/,'banners']
  ];
  const ROLE_DEFAULTS={
  ...
  function apply(u){
    ...
    if(need&&!ok(p,need)){location.replace('dashboard.html?access=denied');return false}
    return true;
  }
  async function boot(){
  ...
  window.PMT_ACCESS_V3={refresh:boot,has:function(n){const u=user();return !!u&&ok(perms(u),n)}};
